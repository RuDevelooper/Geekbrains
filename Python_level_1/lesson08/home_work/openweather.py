...
class GetApiKey:
    ...
    def __init__(self, user_name, user_password):
        ...
        self.app_id = self._auth_and_get_api_key()
    ...
    def write_id_to_file(self):
        with open(os.path.join('app.id'), 'w', encoding='utf-8') as file:
            file.write(self.app_id)

class GetCityList:

    def _download_list(self):
        url = 'http://bulk.openweathermap.org/sample/city.list.json.gz'
        self.city_list = req.urlretrieve(url, os.path.join('city.list.json.gz'))

    def _read_city_list(self):
        with gzip.open
...
# g.go(url='https://home.openweathermap.org/users/sign_out')


a = GetApiKey('347.447@mail.ru', '845484175487')
print(a._auth_and_get_api_key())
a.write_id_to_file()
