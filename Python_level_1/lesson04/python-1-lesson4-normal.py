...
name_regex = '([А-Я][а-я]+)|([A-Z][a-z]+)'
mail_regex = '[a-z]+[a-z0-9_]+@[a-z0-9]+.(ru|com|org)'

name = input('Введите имя: ')
print('Имя введено некорректно!' if re.match(name_regex, name) is None else 'OK')

second_name = input('Введите фамилию: ')
print('Фамилия введена некорректно!' if re.match(name_regex, second_name) is None else 'OK')

mail = input('Введите электронную почту: ')
print('Адрес электронной почты введен некорректно!' if re.match(mail_regex, mail) is None else 'OK')
...
print('В тексте не встречается подряд более одной точки.'
      if re.search('\.{2,}', some_str) is None else 'В тексте встречается более одной точки подряд.')
